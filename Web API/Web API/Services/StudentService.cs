...
namespace Web_API.Services
{
    public interface IStudentService
    {
        ...
        Student Update(Guid id, Student student);
    }
    ...
    public class StudentService : IStudentService
    {
        ...
        {
            var getStudent = _dbContextStudent.Students.FirstOrDefault(s => s.Id == id);
            return getStudent;
        }
        ...
        public Student Update(Guid id, Student student)
        {
            var updateStudent = _dbContextStudent.Students.Where(s => s.Id == id).FirstOrDefault();
